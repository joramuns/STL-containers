...
TEST(SetNanadaug, ConstructorsList) {
  s21::set<int> new_set;
...
TEST(SetNanadaug, ConstructorsList2) {
...
TEST(SetNanadaug, ConstructorsCopy) {
  s21::set<int> new_set;
...
TEST(SetNanadaug, ConstructorsMove) {
  std::initializer_list<int> items{2, 1, 2, 2};
...
TEST(SetNanadaug, ConstructorsMove2) {
  std::initializer_list<int> items{2, 1, 2, 2};
  s21::set<int> my_set(items);
  std::set<int> std_set(items);
...
TEST(SetNanadaug, IteratorTestSolo) {
...
TEST(SetNanadaug, IteratorTestDoubleInc) {
...
TEST(SetNanadaug, IteratorTestDoubleDec) {
...
TEST(SetNanadaug, MinusIterator) {
...
TEST(SetNanadaug, MinusIteratorSolo) {
  std::initializer_list<int> items{2};
  s21::set<int> my_set(items);
  std::set<int> std_set(items);
...
TEST(SetNanadaug, MinusIteratorDuo1) {
  std::initializer_list<int> items{1, 2};
  s21::set<int> my_set(items);
  std::set<int> std_set(items);
...
TEST(SetNanadaug, MinusIteratorDuo2) {
  std::initializer_list<int> items{2, 1};
  s21::set<int> my_set(items);
  std::set<int> std_set(items);
