...
TEST(SetFredacha, Constructor_Default) {
  s21::set<int> s21_set;
  std::set<int> std_set;
...
TEST(SetFredacha, Modifier_Insert_2) {
...
TEST(SetFredacha, Modifier_Insert_3) {
...
TEST(SetFredacha, Lookup_Contains) {
  s21::set<int> s21_set;
  s21_set.insert(1);
  s21_set.insert(2);
  s21_set.insert(3);
...
TEST(SetFredacha, Rehash_And_Insert_In_Collision) {
